...
var Button = function (_React$Component) {
    ...
    _createClass(Button, [{
        ...
        value: function render() {
            ...
            var textStyle = [buttonStyles[size + 'RawText'], buttonStyles[type + 'RawText'], disabled && buttonStyles.disabledRawText, this.state.pressIn && buttonStyles[type + 'HighlightText']];
            var wrapperStyle = [buttonStyles.wrapperStyle, buttonStyles[size + 'Raw'], buttonStyles[type + 'Raw'], disabled && buttonStyles.disabledRaw, this.state.pressIn && activeStyle && buttonStyles[type + 'Highlight'], activeStyle && this.state.touchIt && activeStyle, style];
            var underlayColor = StyleSheet.flatten(buttonStyles[activeStyle ? type + 'Highlight' : type + 'Raw']).backgroundColor;
            var indicatorColor = StyleSheet.flatten(this.state.pressIn ? buttonStyles[type + 'HighlightText'] : buttonStyles[type + 'RawText']).color;
